...
export const metadata: Metadata = {
  ...
  description:
    'Build and ship an app with AI over two weeks (7 September – 21 September 2026), part-time, using v0 + Vercel. Runtime model integration is optional. Open to everyone.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
