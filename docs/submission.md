...
Deadline: **Tue 7 Oct 2026, 23:59 BST (UTC+1)**. Late = not judged, so submit early and update if needed.
...
So judges find everything fast, drop a short README at the top of your project repo:
...
- Record the video early — tech fails at the last minute.
