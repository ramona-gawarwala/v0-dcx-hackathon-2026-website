...
const basics = [
  ...
  { icon: Clock, title: 'Duration', body: 'Two weeks, 23 September – 7 October. Part-time and self-paced — no daily session and no full days blocked. Work with your team around your day job.' },
